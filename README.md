...
Coders Beginners es una app que permite a las personas que se inician en programación, compartir dudas y resolverlas con la ayuda de otros usuarios, encontrar información, y relacionarse con otras personas con los mismos intereses.

### Usuarios 
Los principales usuarios son aquellas personas que se inician y/o tienen interés en programación, además, aquellas que tienen más experiencia y pueden brindar ayuda para resolver dudas. 

### Necesidades que satisface el producto
Permite al usuario crear una cuenta o acceder a la app a través de su cuenta de gmail.
Este producto permite compartir dudas de los usuarios sobre temas específicos de programación.
Permite crear, editar, eliminar y likear contenido y generar relaciones con otras personas con intereses comunes.
